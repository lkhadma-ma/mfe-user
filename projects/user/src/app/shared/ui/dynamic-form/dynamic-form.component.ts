...
@Component({
  ...
  template: `
    ...
    <div *ngIf="isOpen" 
      ...
      <!-- Modal Container -->
      <div class="mfe-user-bg-white mfe-user-rounded-lg mfe-user-shadow-xl mfe-user-max-w-2xl mfe-user-w-full mfe-user-max-h-[90vh] mfe-user-overflow-hidden mfe-user-flex mfe-user-flex-col">
        
        <!-- Form -->
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="mfe-user-flex mfe-user-flex-col mfe-user-h-full mfe-user-overflow-hidden">
          
          <!-- Fixed Header -->
          <div class="mfe-user-flex-shrink-0 mfe-user-p-6 mfe-user-border-b mfe-user-border-gray-200 mfe-user-bg-white">
            <h2 class="mfe-user-text-2xl mfe-user-font-semibold mfe-user-text-gray-900">{{ config.title }}</h2>
            <p *ngIf="config.subtitle" class="mfe-user-mt-1 mfe-user-text-sm mfe-user-text-gray-600">{{ config.subtitle }}</p>
          </div>
          ...
          <div class="mfe-user-flex-1 mfe-user-overflow-y-auto mfe-user-p-6">
            <div class="mfe-user-space-y-6">
              ...
              <!-- Form Sections -->
              <div *ngFor="let section of config.sections" class="mfe-user-space-y-4">
                
                <!-- Section Header -->
                <div *ngIf="section.title" class="mfe-user-mb-4">
                  <h3 class="mfe-user-text-lg mfe-user-font-medium mfe-user-text-gray-900">{{ section.title }}</h3>
                  <p *ngIf="section.description" class="mfe-user-mt-1 mfe-user-text-sm mfe-user-text-gray-600">{{ section.description }}</p>
                </div>

                <!-- Form Fields Grid -->
                <div [class]="getGridClass(section.columns || 1)" class="mfe-user-gap-4">
                  ...
                  <div *ngFor="let field of section.fields" 
                    ...
                    <!-- Checkbox -->
                    <div *ngIf="field.type === 'checkbox'" class="mfe-user-flex mfe-user-items-center">
                      <label class="mfe-user-flex mfe-user-items-center mfe-user-space-x-2">
                        <input
                          type="checkbox"
                          [formControlName]="field.key"
                        ...
                        <span class="mfe-user-text-sm mfe-user-text-gray-700">{{ field.label }}</span>
                      </label>
                    </div>
                    ...
                    <div *ngIf="field.type === 'radio'">
                      <label class="mfe-user-block mfe-user-text-sm mfe-user-font-medium mfe-user-text-gray-700">
                        {{ field.label }}
                        <span *ngIf="field.required" class="mfe-user-text-red-500">*</span>
                      </label>
                      <div class="mfe-user-mt-2 mfe-user-space-y-2">
                        <div *ngFor="let option of field.options" class="mfe-user-flex mfe-user-items-center">
                          <input
                            type="radio"
                          ...
                          <label [for]="field.key + '-' + option.value" class="mfe-user-ml-2 mfe-user-text-sm mfe-user-text-gray-700">
                            {{ option.label }}
                          </label>
                        </div>
                      </div>
          ...
          <!-- Fixed Actions -->
          <div class="mfe-user-flex-shrink-0 mfe-user-flex mfe-user-justify-end mfe-user-space-x-3 mfe-user-p-6 mfe-user-border-t mfe-user-border-gray-200 mfe-user-bg-gray-50">
            <button
              type="button"
              (click)="onCancel()"
...
export class DynamicFormComponent implements OnInit {
  ...
  private createForm() {
    ...
    this.config.sections.forEach(section => {
      section.fields.forEach(field => {
        ...
        const value = this.initialData[field.key] || 
  ...
  onBackdropClick(event: MouseEvent) {
    if ((event.target as HTMLElement).classList.contains('mfe-user-bg-opacity-50')) {
      this.close();
    }
  }
